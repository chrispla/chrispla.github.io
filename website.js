...
//performances page
var rach_title = "Sergei Rachmaninoff - Piano Concerto No. 2, I. Moderato";
var rach_performance = "Christos Plachouras, Ioannis Potamousis, Live at NYUAD Blue Hall, 13th of December, 2018";
var rach_img;
var messiaen_title = "Olivier Messiaen - Vingt Regards - II. Regard de l'étoile";
var messiaen_performance = "Christos Plachouras, Studio Odeon, Athens, 19th of October, 2016";
var messiaen_img;
var bach_title = "J.S. Bach - Partita No. 2 in C minor, I. Simfonia";
...
//other_projects page
var koechlin_title = "Charles Koechlin - Computational Musicology (in progress)";
...
var koechlin_img;
var tool_title = "Electronic Composition Tool (in progress)";
...
var tool_img;
var masc_title = "Computational Analysis and Musical Heritage Preservation - MaSC (in progress)";
...
var masc_img;
var omr_title = "Music Notation Software - Optical Music Recognition (in progress)";
...
function tabTransition (currentState, tabvar, currentY, desiredY) {
  ...
  if (state==currentState+2) {
    ...
    //remember to change homebutton color according to color of tab
...
function draw() {
  ...
  if (state==9) { //last animation for compositions page
    ...
    textStyle(NORMAL);
    text(string_quartet_performance, windowWidth/2 + 133, windowHeight/4 + 190, windowWidth/3, 2*windowHeight/3);
    ...
    textStyle(NORMAL);
    text(mapinmusic_performance, windowWidth/2 + 133, windowHeight/4 + 290, windowWidth/3, 2*windowHeight/3);
    ...
    textStyle(NORMAL);
    text(flowersescape_performance, windowWidth/2 + 133, windowHeight/4 + 390, windowWidth/3, 2*windowHeight/3);
  ...
  if (state==14) { //last animations of performances page
    ...
    textStyle(NORMAL);
    text(rach_performance, windowWidth/2 + 133, windowHeight/4 + 90, windowWidth/3, 2*windowHeight/3);
    ...
    textStyle(NORMAL);
    text(messiaen_performance, windowWidth/2 + 133, windowHeight/4 + 190, windowWidth/3, 2*windowHeight/3);
    ...
    textStyle(NORMAL);
    text(bach_performance, windowWidth/2 + 133, windowHeight/4 + 290, windowWidth/3, 2*windowHeight/3);
...
//----------##########PUBLICATIONS##########----------//
  ...
  if (state==22 || state==23 || state==24) {
    tabTransition(22, other_projects, windowHeight/2 +83, windowHeight/4);
  }
  ...
  if (state==24) { //last animations of other_projects page
    ...
    textStyle(BOLD);
    textSize(14);
    text(koechlin_title, windowWidth/2 + 125, windowHeight/4 + 50, windowWidth/3, 2*windowHeight/3);
    textStyle(NORMAL);
    text(koechlin_description, windowWidth/2 + 125, windowHeight/4 + 70, windowWidth/3, 2*windowHeight/3);
    image(koechlin_img, windowWidth/2 + 25, windowHeight/4 + 50, 75, 75);

    //Composition tool
    textStyle(BOLD);
    textSize(14);
    text(tool_title, windowWidth/2 + 125, windowHeight/4 + 200, windowWidth/3, 2*windowHeight/3);
    textStyle(NORMAL);
    text(tool_description, windowWidth/2 + 125, windowHeight/4 + 220, windowWidth/3, 2*windowHeight/3);
    image(tool_img, windowWidth/2 + 25, windowHeight/4 + 200, 75, 75);

    //MaSC
    textStyle(BOLD);
    textSize(14);
    text(masc_title, windowWidth/2 + 125, windowHeight/4 + 350, windowWidth/3, 2*windowHeight/3);
    textStyle(ITALIC);
    text(masc_description, windowWidth/2 + 125, windowHeight/4 + 370, windowWidth/3, 2*windowHeight/3);
    image(masc_img, windowWidth/2 + 25, windowHeight/4 + 350, 75, 75);
  ...
  if (state==25) { //static other_projects page
    ...
    fill(0);
    textSize(24);
    text(other_projects, (windowWidth/2) + 33, windowHeight/4);
  ...
  //---Home button---//
  if (state==5 || state==10 || state==15 || state==20 || state==25 || state==30) {
    //remember to change homebutton color according to color of tab
    fill(0);
    textStyle(BOLD);
    textSize(24);

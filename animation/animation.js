...
function particle_fadein() {
  ...
  for (var i = 0; i < particleNumber; i++) {
    ...
    ellipse(particleXpos[i], particleYpos[i], 10*(sin(animation_timer)), 10*sin(animation_timer));
  }
}
...
function particle_fadeout() {
  ...
  for (var i = 0; i < particleNumber; i++) {
    ...
    ellipse(particleXpos[i], particleYpos[i], 10-10*(sin(animation_timer)), 10-10*sin(animation_timer));
  }
}
